...
// 	//char *test_tab_cmd[] = {"cat -e", NULL};								// 1cmd NB
// 	//char *test_tab_cmd[] = {"echo bla", NULL};							// 1 cmd B

// 	//char *test_tab_cmd[] = {"ls -l", "cat -e", NULL};					// 2 cmd NB
// 	//char *test_tab_cmd[] = {"echo bla", "pwd", NULL};					// 2 cmd B
// 	//char *test_tab_cmd[] = {"cat -e", "pwd", NULL};						// 2 cmd NB/B
...
// 	/*---------------------outfiles testing-----------------*/
// 	/*-- 1 cmd --*/
// 	//char *redi_out[] = {NULL};											// 1 cmd, no out
...
// 	/*----------------------heredoc testing-------------------*/
// 	/*-- 1 cmd --*/
// 	//char *redi_here[] = {NULL}; 										//	1 cmd, no heredoc
...
// 	/*-------------------append testing---------------------*/
// 	/*-- 1 cmd --*/
// 	//char *test_app[] = {NULL}; 											// 1 cmd, no app
// 	//char *redi_out[] = {NULL};								// 2 cmd, no out

// 	//char *test_app[] = {"A_app1", NULL}; 								// 1 cmd, 1 app
// 	//char *redi_out[] = {NULL, NULL};								// 2 cmd, no out
...
// 	// char *redi_out[] = {NULL, "out2", NULL};							//2 cmd, 1 out
...
// 	// char *redi_out[] = {"out1", "out1", NULL};							//2 cmd, 1 out
...
// 	//char *redi_out[] = {NULL, NULL, NULL, NULL};								// 2 cmd, no out
...
// 	// char *redi_out[] = {"o1", "o2", "o3", NULL};					// 3 cmd, 1 out
...
// 	// char *redi_out[] = {NULL, "o2", "o3", NULL};					// 3 cmd, 1 out

// 	// char *test_app[] = {NULL, "O_out2 A_app2", "A_a3 O_o3", NULL}; 		// 3 cmd, 2 app, OUT, NULL
// 	// char *redi_out[] = {NULL, "o2", "o3", NULL};					// 3 cmd, 1 out

// 	// char *test_app[] = {"O_o1 A_a1", "A_a2 O_o2", "O_o3 A_a2",  NULL}; 	// 3 cmd, 2 app, APP, SAME APP
// 	// char *redi_out[] = {"o1", "o2", "o3", NULL};					// 3 cmd, 1 out

// 	// char *test_app[] = {"O_o1 A_a1", "A_a2 O_o2", "A_a3 O_o2",  NULL}; 	// 3 cmd, 2 app, APP, SAME OUT
// 	// char *redi_out[] = {"o1", "o2", "o2", NULL};					// 3 cmd, 1 out
